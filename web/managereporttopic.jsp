                        ...
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">แสดงการฝึกอบรมตามหมวด</h5>
                                            ...
                                            <div class="row">
                                                <div class="col-2">
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-control form-control-sm text-center" id="evaluation_type" name="evaluation_type" style="width: 100%" disabled>
